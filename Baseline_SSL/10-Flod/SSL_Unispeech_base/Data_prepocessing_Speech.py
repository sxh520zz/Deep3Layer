...
processor = AutoProcessor.from_pretrained("/mnt/data1/liyongwei/SSL_Models/patrickvonplaten/unispeech-sat-base-timit-ft")
model = UniSpeechModel.from_pretrained("/mnt/data1/liyongwei/SSL_Models/patrickvonplaten/unispeech-sat-base-timit-ft")
...
if __name__=="__main__":
    ...
    file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Baseline_SSL/10-Flod/SSL_Unispeech_base/Speech_data.pickle', 'wb')

...
class SpeechRecognitionModel(nn.Module):
    def __init__(self, args):
        ...
        self.feature_extractor = WavLMModel.from_pretrained("/mnt/data1/liyongwei/SSL_Models/patrickvonplaten/wavlm-libri-clean-100h-large")

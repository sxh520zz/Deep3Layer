...
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Baseline_SSL/15-Flod/SSL_WavLM_base/Speech_data.pickle', 'rb') as file:
...
file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Baseline_SSL/15-Flod/SSL_WavLM_base/Final_result.pickle', 'wb')
pickle.dump(Final_result,file)
file.close()
file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Baseline_SSL/15-Flod/SSL_WavLM_base/Final_f1.pickle', 'wb')

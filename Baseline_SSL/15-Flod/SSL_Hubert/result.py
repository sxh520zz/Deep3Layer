...
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Baseline_SSL/15-Flod/SSL_Hubert/Final_result.pickle', 'rb') as file:
    final_result =pickle.load(file)
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Baseline_SSL/15-Flod/SSL_Hubert/Final_f1.pickle', 'rb') as file:

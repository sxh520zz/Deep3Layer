...
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_Wav2vec/Speech_data.pickle', 'rb') as file:
...
def main(name):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if (accuracy_ccc > ccc and  accuracy_mae < mae):
            ...
            ccc = accuracy_ccc
            mae = accuracy_mae
            name_1 = '/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_Wav2vec/SSL_' + str(name) + '.pkl'
    ...
    dir_tem_1 = '/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_Wav2vec/Final_result_' + name + '.pickle'
    dir_tem_2 = '/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_Wav2vec/Final_CCC_' + name + '.pickle'

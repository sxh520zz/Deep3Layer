...
def Feature(data,args):
    ...
    input_data_spec_1 = []
    for i in range(len(data)):
        input_data_spec_1.append(data[i]['spec_data'])
    input_data_spec_1 = STD(input_data_spec_1)
    input_label = []
    for i in range(len(data)):
    ...
    return input_data_spec,input_data_spec_1,input_label,input_data_id,input_label_org

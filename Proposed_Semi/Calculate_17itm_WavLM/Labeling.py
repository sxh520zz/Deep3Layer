...
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_WavLM/Train_data_IEM.pickle', 'rb') as file:
...
def main(name):
    ...
    dir_tem = '/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_WavLM/IEMOCAP_result_' + name + '.pickle'

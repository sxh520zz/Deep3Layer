...
if __name__ == '__main__':
    ...
    train_data_map = Seg_IEMOCAP(train_data_thre[0],train_data_text,train_data_trad)
    Train_data = Train_data(train_data_map)

    file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/Hubert_Large_Proposed/Train_data.pickle', 'wb')

...
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/Hubert_Large_Proposed_CASIA/Final_result.pickle', 'rb') as file:
    final_result =pickle.load(file)
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/Hubert_Large_Proposed_CASIA/Final_f1.pickle', 'rb') as file:
...
predict_label_onehot = np.eye(6)[predict_label.astype(int)]
true_label_onehot = np.eye(6)[true_label.astype(int)]

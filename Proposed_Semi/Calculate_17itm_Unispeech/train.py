...
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_Unispeech/Speech_data.pickle', 'rb') as file:
...
def main(name):
    ...
    dir_tem_1 = '/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_Unispeech/Final_result_' + name + '.pickle'
    dir_tem_2 = '/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_Unispeech/Final_CCC_' + name + '.pickle'

...
class GRUModel(nn.Module):
    def __init__(self,input_size,hidden_size,output_size,args):
        ...
        # adapter
        self.adapter_to_output_layer_weights = nn.Parameter(torch.ones(4) / 4)
    ...
    def forward(self, U, A):
        ...
        concatenated_out = (A * norm_weights.view(-1 ,1)).sum(dim=1)
        A = concatenated_out.reshape(concatenated_out.shape[0], -1)

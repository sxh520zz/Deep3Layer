...
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_Data2vec_CASIA/Train_data_CASIA.pickle', 'rb') as file:
...
def main(name):
    ...
    dir_tem = '/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Semi/SSL_Data2vec_CASIA/CASIA_result_' + name + '.pickle'

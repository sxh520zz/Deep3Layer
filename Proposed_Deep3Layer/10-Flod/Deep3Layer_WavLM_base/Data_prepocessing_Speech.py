...
processor = AutoProcessor.from_pretrained("/mnt/data1/liyongwei/SSL_Models/patrickvonplaten/wavlm-libri-clean-100h-base")
model = WavLMModel.from_pretrained("/mnt/data1/liyongwei/SSL_Models/patrickvonplaten/wavlm-libri-clean-100h-base")
...
if __name__=="__main__":
    ...
    file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/10-Flod/Deep3Layer_WavLM_base/Speech_data.pickle', 'wb')

...
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/10-Flod/Deep3Layer_WavLM_base/Speech_data.pickle', 'rb') as file:
...
file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/10-Flod/Deep3Layer_WavLM_base/Final_result.pickle', 'wb')
pickle.dump(Final_result,file)
file.close()
file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/10-Flod/Deep3Layer_WavLM_base/Final_f1.pickle', 'wb')
pickle.dump(Final_f1,file)
file.close()
file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/10-Flod/Deep3Layer_WavLM_base/Final_cont.pickle', 'wb')

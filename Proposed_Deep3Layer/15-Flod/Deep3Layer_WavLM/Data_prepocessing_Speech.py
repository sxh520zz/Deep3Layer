...
processor = AutoProcessor.from_pretrained("/mnt/data1/liyongwei/SSL_Models/patrickvonplaten/wavlm-libri-clean-100h-large")
model = WavLMModel.from_pretrained("/mnt/data1/liyongwei/SSL_Models/patrickvonplaten/wavlm-libri-clean-100h-large")
...
if __name__=="__main__":
    ...
    file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/15-Flod/Deep3Layer_WavLM/Speech_data.pickle', 'wb')

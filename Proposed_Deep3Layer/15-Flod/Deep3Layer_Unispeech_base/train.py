...
with open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/15-Flod/Deep3Layer_Unispeech_base/Speech_data.pickle', 'rb') as file:
...
def Test():
    ...
    with torch.no_grad():
        for batch_idx, (data_1, mid_1,mid_2,mid_3,mid_4,mid_5,mid_6,mid_7,mid_8,mid_9,mid_10,mid_11,mid_12,mid_13,mid_14,mid_15,mid_16,mid_17,target) in enumerate(test_loader):
            ...
            label_cont.append(label_1)
            label_cont.append(label_2)
            label_cont.append(label_3)
            label_cont.append(label_4)
            label_cont.append(label_5)
            label_cont.append(label_6)
            label_cont.append(label_7)
            label_cont.append(label_8)
            label_cont.append(label_9)
            label_cont.append(label_10)
            label_cont.append(label_11)
            label_cont.append(label_12)
            label_cont.append(label_13)
            label_cont.append(label_14)
            label_cont.append(label_15)
            label_cont.append(label_16)
            label_cont.append(label_17)
...
file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/15-Flod/Deep3Layer_Unispeech_base/Final_result.pickle', 'wb')
pickle.dump(Final_result,file)
file.close()
file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/15-Flod/Deep3Layer_Unispeech_base/Final_f1.pickle', 'wb')
pickle.dump(Final_f1,file)
file.close()
file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/15-Flod/Deep3Layer_Unispeech_base/Final_cont.pickle', 'wb')

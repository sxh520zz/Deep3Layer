...
processor = Wav2Vec2Processor.from_pretrained("/mnt/data1/liyongwei/SSL_Models/facebook/wav2vec2-base-960h")
model = Wav2Vec2Model.from_pretrained("/mnt/data1/liyongwei/SSL_Models/facebook/wav2vec2-base-960h")
...
if __name__=="__main__":
    ...
    file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/15-Flod/Deep3Layer_Wav2vec_base/Speech_data.pickle', 'wb')

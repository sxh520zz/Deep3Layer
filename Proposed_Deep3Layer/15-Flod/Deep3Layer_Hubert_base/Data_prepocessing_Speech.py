...
model = HubertModel.from_pretrained("/mnt/data1/liyongwei/SSL_Models/facebook/hubert-base-ls960")   # 用于提取通用特征，768维
...
if __name__=="__main__":
    ...
    file = open('/mnt/data1/liyongwei/Project/Xiaohan_code/Deep3Layer/Proposed_Deep3Layer/15-Flod/Deep3Layer_Hubert_base/Speech_data.pickle', 'wb')
